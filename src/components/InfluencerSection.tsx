...
import influ1 from "../assets/Creatives and Campaigns/Futre of AI in Pakistan Cinema/1.jpeg";
import influ2 from "../assets/Creatives and Campaigns/Futre of AI in Pakistan Cinema/2.jpeg";
import influ3 from "../assets/Creatives and Campaigns/Futre of AI in Pakistan Cinema/3.jpeg";
import influ4 from "../assets/Creatives and Campaigns/Futre of AI in Pakistan Cinema/4.jpeg";

const influencerImages = [
  { src: influ1, alt: "Creative collaboration 1" },
  { src: influ2, alt: "Creative collaboration 2" },
  { src: influ3, alt: "Creative collaboration 3" },
  { src: influ4, alt: "Creative collaboration 4" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-4 text-sm md:text-base text-muted-foreground leading-relaxed">
              I collaborate with brands, organizations, and media outlets to craft campaigns that feel authentic, look premium, and perform.
              From concept to direction and final edits, I focus on storytelling that makes audiences stop and
              engage.
            </p>
