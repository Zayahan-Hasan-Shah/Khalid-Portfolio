...
import product3 from "../assets/Gulffood Green Brazil picture.jpeg";

const memories = [
  {
    id: 1,
    category: "Media Gala & Cinema Events",
    icon: Video,
  ...
  {
    id: 2,
    category: "Public Service Campaigns",
    icon: Briefcase,
                      ...
                      <div className="relative w-full h-full overflow-hidden rounded-2xl">
                        <img
                          ...
                          className={`w-full h-full object-cover transition-transform duration-700 ${
                            (category as any).rotate ? "rotate-90 scale-125 group-hover:scale-[1.35]" : "group-hover:scale-110"
                          }`}
                          loading="lazy"
                        />
